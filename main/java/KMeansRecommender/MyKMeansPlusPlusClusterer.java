 ...
 * @since 3.2
 */
public class MyKMeansPlusPlusClusterer<T extends Clusterable> extends Clusterer<T> {
     ...
     */
    public MyKMeansPlusPlusClusterer(final int k, final int maxIterations, final DistanceMeasure measure) {
